...
public class CompetitiveLadderAchievements implements WithAssertions {
    ...
    private RawAchievement nemsis(String className, int numberOfVictories, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .displayName("Achievement completed: " + StringUtils.capitalize(className) + " Nemesis (" + numberOfVictories + " games)")
                .displayCardId(icon)
                .displayCardType("minion")
                .difficulty("epic")
                .emptyText("Win " + numberOfVictories + " games against " + StringUtils.capitalize(className) + " in less than " + periodOfTimeInHours + " hours in Ranked Standard")
                .completedText("You won " + numberOfVictories + " games against " + StringUtils.capitalize(className) + " in less than " + periodOfTimeInHours + " hours")
                .maxNumberOfRecords(3)
