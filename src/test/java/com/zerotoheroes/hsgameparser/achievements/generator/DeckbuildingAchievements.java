...
public class DeckbuildingAchievements implements WithAssertions {
    ...
    private RawAchievement classic(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .name("Classic")
                .displayName("Achievement completed: Classic (" + getLeagueText(minimumRank) + ")")
                ...
                .completedText("Completed in " + getLeagueText(minimumRank) + " or better")
    ...
    private RawAchievement balanced(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .displayName("Achievement completed: Perfectly Balanced (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement richlyBalanced(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .displayName("Achievement completed: Richly Balanced (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement minion(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("A Whole Army")
                .displayName("Achievement completed: A Whole Army (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement sorcerer(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Sorcerer")
                .displayName("Achievement completed: Sorcerer (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement loneSurvivor(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Lone Survivor")
                .displayName("Achievement completed: Lone Survivor (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement miracle(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("The Miracle")
                .displayName("Achievement completed: The Miracle (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement swordAndSpell(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .displayName("Achievement completed: Swords and Spells (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement lifesteal(int minimumRank, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Lifesteal")
                .displayName("Achievement completed: Lifesteal (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement theVoid(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("The Void")
                .displayName("Achievement completed: The Void (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement quiet(int minimumRank, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("So quiet")
                .displayName("Achievement completed: So Quiet (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement freeSpeech(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Free Speech")
                .displayName("Achievement completed: Free Speech (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement thousandCut(int minimumRank, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .displayName("Achievement completed: Death by a Thousand Cuts (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement fragileNature(int minimumRank, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Fragile Nature")
                .displayName("Achievement completed: Fragile Nature (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement summoner(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Summoner")
                .displayName("Achievement completed: Summoner (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement random(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("My Own Casino")
                .displayName("Achievement completed: My Own Casino (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement simple(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .displayName("Achievement completed: Keeping it Simple (" + getLeagueText(minimumRank) + ")")
    ...
    private RawAchievement complex(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Complexity")
                .displayName("Achievement completed: Complexity (" + getLeagueText(minimumRank) + ")")
