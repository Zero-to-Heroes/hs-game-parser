...
public class DeckbuildingAchievements implements WithAssertions {
    ...
    private List<RawAchievement> clasics() {
        ...
        return minimumRanks.stream()
                .map(minimumRank -> classic(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement classic(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .name("Classic")
                .displayName("Win one game with a deck containing only Classic and Basic cards in Ranked Standard")
                .displayCardId("CS2_127")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing only Classic and Basic cards in Ranked Standard")
                .completedText("Win one game with a deck containing only Classic and Basic cards in Ranked Standard")
    ...
    private List<RawAchievement> epics() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> epic(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement epic(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Epic")
                .displayName("Achievement completed: Epic (" + getLeagueText(minimumRank) + ")")
                .displayCardId("TB_KTRAF_HP_RAF4")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing only epic cards in Ranked Standard")
                .completedText("Win one game with a deck containing only epic cards in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> balanceds() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> balanced(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement balanced(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .displayName("Win one game with a deck containing 10 common, rare and epic cards in Ranked Standard")
                .displayCardId("ULDA_BOSS_62h")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing 10 common, rare and epic cards in Ranked Standard")
                .completedText("Win one game with a deck containing 10 common, rare and epic cards in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> richlyBalanceds() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> richlyBalanced(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement richlyBalanced(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .displayName("Win one game with a deck containing 10 rare, epic and legendary cards in Ranked Standard")
                .displayCardId("TRLA_116")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing 10 rare, epic and legendary cards in Ranked Standard")
                .completedText("Win one game with a deck containing 10 rare, epic and legendary cards in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> minions() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> minion(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement minion(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("A Whole Army")
                .displayName("Win one game with a deck containing only minions in Ranked Standard")
                .displayCardId("BOT_912")
                .displayCardType("spell")
                .difficulty("rare")
                .text("Win one game with a deck containing only minions in Ranked Standard")
                .completedText("Win one game with a deck containing only minions in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> sorcerers() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> sorcerer(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement sorcerer(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Sorcerer")
                .displayName("Win one game with a deck containing only spells in Ranked Standard")
                .displayCardId("OG_090")
                .displayCardType("spell")
                .difficulty("rare")
                .text("Win one game with a deck containing only spells in Ranked Standard")
                .completedText("Win one game with a deck containing only spells in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> loneSurvivors() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> loneSurvivor(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement loneSurvivor(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Lone Survivor")
                .displayName("Win one game with a deck containing 1 minion and 29 spells in Ranked Standard")
                .displayCardId("LOOT_124")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing 1 minion and 29 spells in Ranked Standard")
                .completedText("Win one game with a deck containing 1 minion and 29 spells in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> miracles() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> miracle(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement miracle(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("The Miracle")
                .displayName("Win one game with a deck containing 29 minions and 1 spell in Ranked Standard")
                .displayCardId("ULD_216")
                .displayCardType("spell")
                .difficulty("rare")
                .text("Win one game with a deck containing 29 minions and 1 spell in Ranked Standard")
                .completedText("Win one game with a deck containing 29 minions and 1 spell in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> swordAndSpells() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> swordAndSpell(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement swordAndSpell(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .displayName("Win one game with a deck containing 15 minions and 15 spells in Ranked Standard")
                .displayCardId("ULD_329")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing 15 minions and 15 spells in Ranked Standard")
                .completedText("Win one game with a deck containing 15 minions and 15 spells in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> lifesteals() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> lifesteal(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement lifesteal(int minimumRank, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Lifesteal")
                .displayName("Win one game with a deck containing at least " + minLifestealCards + " cards with lifesteal in Ranked Standard")
                .displayCardId("DAL_047")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing at least " + minLifestealCards + " cards with lifesteal in Ranked Standard")
                .completedText("Win one game with a deck containing at least " + minLifestealCards + " cards with lifesteal in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> voids() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> theVoid(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement theVoid(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("The Void")
                .displayName("Win one game with a deck containing no cards with the letter \"e\" in its (English) name in Ranked Standard")
                .displayCardId("ULD_134")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing no cards with the letter \"e\" in its (English) name in Ranked Standard")
                .completedText("Win one game with a deck containing no cards with the letter \"e\" in its (English) name in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> quiets() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> quiet(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement quiet(int minimumRank, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("So quiet")
                .displayName("Win one game with a deck containing at least " + minNumberOfMinions + " minions and no battlecry or deathrattle card in Ranked Standard")
                .displayCardId("LOE_077")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing at least " + minNumberOfMinions + " minions and no battlecry or deathrattle card in Ranked Standard")
                .completedText("Win one game with a deck containing at least " + minNumberOfMinions + " minions and no battlecry or deathrattle card in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> freeSpeeches() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> freeSpeech(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement freeSpeech(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Free Speech")
                .displayName("Win one game with a deck containing 30 cards with Battlecry in Ranked Standard")
                .displayCardId("ICC_809")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing 30 cards with Battlecry in Ranked Standard")
                .completedText("Win one game with a deck containing 30 cards with Battlecry in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> thousandCuts() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> thousandCut(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement thousandCut(int minimumRank, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .displayName("Win one game with a deck containing at least " + minNumberOfMinions + " minions with 1 attack or less and no spell in Ranked Standard")
                .displayCardId("DAL_773")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing at least " + minNumberOfMinions + " minions with 1 attack or less and no spell in Ranked Standard")
                .completedText("Win one game with a deck containing at least " + minNumberOfMinions + " minions with 1 attack or less and no spell in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> fragileNatures() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> fragileNature(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement fragileNature(int minimumRank, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Fragile Nature")
                .displayName("Win one game with a deck containing at least " + minNumberOfMinions + " minions with 1 health and no spell in Ranked Standard")
                .displayCardId("GIL_665")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing at least " + minNumberOfMinions + " minions with 1 health and no spell in Ranked Standard")
                .completedText("Win one game with a deck containing at least " + minNumberOfMinions + " minions with 1 health and no spell in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> summoners() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> summoner(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement summoner(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Summoner")
                .displayName("Win one game with a deck containing only cards with the word \"Summon\" in their text or name in Ranked Standard")
                .displayCardId("DAL_575")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing only cards with the word \"Summon\" in their text or name in Ranked Standard")
                .completedText("Win one game with a deck containing only cards with the word \"Summon\" in their text or name in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> randoms() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> random(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement random(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("My Own Casino")
                .displayName("Win one game with a deck containing only cards with the word \"random\" in their text or name in Ranked Standard")
                .displayCardId("KAR_009")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing only cards with the word \"random\" in their text or name in Ranked Standard")
                .completedText("Win one game with a deck containing only cards with the word \"random\" in their text or name in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> simples() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> simple(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement simple(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .displayName("Win one game with a deck containing only cards with at most 3 words in their text in Ranked Standard")
                .displayCardId("CS2_182")
                .displayCardType("minion")
                .difficulty("rare")
                .text("Win one game with a deck containing only cards with at most 3 words in their text in Ranked Standard")
                .completedText("Win one game with a deck containing only cards with at most 3 words in their text in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private List<RawAchievement> complexes() {
        List<Integer> minimumRanks = newArrayList(5, 4, 3, 2, 1);
        return minimumRanks.stream()
                .map(minimumRank -> complex(minimumRank, minimumRank == 5))
                .collect(Collectors.toList());
    }
    ...
    private RawAchievement complex(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .priority(-minimumRank)
                .name("Complexity")
                .displayName("Win one game with a deck containing only cards with at least 8 words in their text in Ranked Standard")
                .displayCardId("CS2_233")
                .displayCardType("spell")
                .difficulty("rare")
                .text("Win one game with a deck containing only cards with at least 8 words in their text in Ranked Standard")
                .completedText("Win one game with a deck containing only cards with at least 8 words in their text in Ranked Standard")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
