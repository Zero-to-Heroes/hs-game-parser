...
public class DeckbuildingAchievements implements WithAssertions {
    ...
    private RawAchievement classic(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .completedText("You won with a deck containing only Classic and Basic cards at rank " + minimumRank + " or better")
    ...
    private RawAchievement epic(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .completedText("You won with a deck containing only epic cards at rank " + minimumRank + " or better")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private RawAchievement lifesteal(int minimumRank, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .completedText("You won with a deck containing at least " + minLifestealCards + " cards with lifesteal at rank " + minimumRank + " or better")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private RawAchievement theVoid(int minimumRank, boolean isRoot) {
        return RawAchievement.builder()
                ...
                .completedText("You won with a deck containing no cards with the letter \"e\" in its name at rank " + minimumRank + " or better")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
    ...
    private RawAchievement quiet(int minimumRank, boolean isRoot) {
        ...
        return RawAchievement.builder()
                ...
                .completedText("You won with a deck containing at least " + minNumberOfMinions + " minions and no battlecry or deathrattle card at rank " + minimumRank + " or better")
                .maxNumberOfRecords(3)
                .points(5)
                .requirements(newArrayList(
                        Requirement.builder().type(GAME_TYPE).values(newArrayList(RANKED)).build(),
